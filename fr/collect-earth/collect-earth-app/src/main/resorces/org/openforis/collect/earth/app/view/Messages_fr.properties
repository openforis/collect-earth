...
public class GenerateRDBAnalysisListener implements ActionListener {
	private Logger logger = LoggerFactory.getLogger( GenerateRDBAnalysisListener.class);
	private JFrame frame;
	private GenerateDatabaseStarter saikuStarter;

	public GenerateRDBAnalysisListener(JFrame frame, GenerateDatabaseStarter saikuStarter) {
		this.frame = frame;
