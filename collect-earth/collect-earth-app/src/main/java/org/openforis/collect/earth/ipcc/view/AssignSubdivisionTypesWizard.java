...
public class AssignSubdivisionTypesWizard {
	...
	public static void main(String[] args) {
		...
		Integer id  =1;
		luses.add( new ForestSubdivision("a", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("a", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("b", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("c", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("f", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("b", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("f", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("a", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("a", "aaaaa", ManagementType.MANAGED , id++ )  );
		...
		luses.add( new CroplandSubdivision("a", "aaaaa", CroplandType.ANNUAL , id++ )  );
		luses.add( new CroplandSubdivision("a", "aaaaa", CroplandType.ANNUAL , id++ )  );
		luses.add( new CroplandSubdivision("b", "aaaaa", CroplandType.ANNUAL , id++ )  );
		luses.add( new CroplandSubdivision("c", "aaaaa", CroplandType.ANNUAL , id++ )  );
		luses.add( new CroplandSubdivision("f", "aaaaa", CroplandType.ANNUAL , id++ )  );
		luses.add( new CroplandSubdivision("b", "aaaaa", CroplandType.ANNUAL , id++ )  );
		luses.add( new CroplandSubdivision("f", "aaaaa", CroplandType.ANNUAL , id++ )  );
		luses.add( new CroplandSubdivision("a", "aaaaa", CroplandType.ANNUAL , id++ )  );
		luses.add( new CroplandSubdivision("a", "aaaaa", CroplandType.ANNUAL , id++ )  );
		...
		luses.add( new WetlandSubdivision("a", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new WetlandSubdivision("b", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new WetlandSubdivision("c", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new WetlandSubdivision("f", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new WetlandSubdivision("b", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new WetlandSubdivision("f", "aaaaa", ManagementType.MANAGED , id++ )  );
		
		luses.add( new GrasslandSubdivision("a", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new GrasslandSubdivision("b", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new GrasslandSubdivision("c", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new GrasslandSubdivision("f", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new GrasslandSubdivision("b", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new GrasslandSubdivision("f", "aaaaa", ManagementType.MANAGED , id++ )  );
		
		luses.add( new OtherlandSubdivision("a", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new OtherlandSubdivision("b", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new OtherlandSubdivision("c", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new OtherlandSubdivision("f", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new OtherlandSubdivision("b", "aaaaa", ManagementType.MANAGED , id++ )  );
		luses.add( new OtherlandSubdivision("f", "aaaaa", ManagementType.MANAGED , id++ )  );

		luses.add( new SettlementSubdivision("a", "aaaaa", SettlementType.TREED , id++ )  );
		luses.add( new SettlementSubdivision("b", "aaaaa", SettlementType.TREED , id++ )  );
		luses.add( new SettlementSubdivision("c", "aaaaa", SettlementType.TREED , id++ )  );
		luses.add( new SettlementSubdivision("f", "aaaaa", SettlementType.TREED , id++ )  );
		luses.add( new SettlementSubdivision("b", "aaaaa", SettlementType.OTHER , id++ )  );
		luses.add( new SettlementSubdivision("f", "aaaaa", SettlementType.OTHER , id++ )  );
