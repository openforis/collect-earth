...
public class AssignSubdivisionTypesWizard {
	...
	public static void main(String[] args) {
		...
		Integer id  =1;
		luses.add( new ForestSubdivision("a", "aaaaa", ManagementTypeEnum.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("a", "aaaaa", ManagementTypeEnum.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("b", "aaaaa", ManagementTypeEnum.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("c", "aaaaa", ManagementTypeEnum.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("f", "aaaaa", ManagementTypeEnum.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("b", "aaaaa", ManagementTypeEnum.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("f", "aaaaa", ManagementTypeEnum.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("a", "aaaaa", ManagementTypeEnum.MANAGED , id++ )  );
		luses.add( new ForestSubdivision("a", "aaaaa", ManagementTypeEnum.MANAGED , id++ )  );
