...
public abstract class AbstractSubdivisionPage extends AbstractWizardPage {
	...
	public AbstractSubdivisionPage(LandUseCategoryEnum category) {
		...
		List<AbstractLandUseSubdivision<?>> subdivisionsInCategory = LandUseSubdivisionUtils
				.getSubdivisionsByCategory(category);
		...
		final Border border = new TitledBorder(new BevelBorder(BevelBorder.LOWERED), getLabel());
		setBorder(border);
