...
public class AboutDialog extends JDialog {
	...
	public AboutDialog(JFrame parent, String title) {
		...
		try {
			...
			b.add(new JLabel(Messages.getString("AboutDialog.3"))); //$NON-NLS-1$
			JLabel comp = new JLabel("<html>" + Messages.getString("AboutDialog.5") + "</html>"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			JLabel comp2 = new JLabel("<html><a href='https://github.com/openforis/collect-earth/blob/master/collect-earth/CHANGELOG.md'>" + Messages.getString("AboutDialog.4") + "</a></html>"); //$NON-NLS-1$ //$NON-NLS-2$
